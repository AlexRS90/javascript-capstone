...
export const create = async (id) => {
  ...
  const rsvtns = await fetch(`https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/${appID}/reservations?item_id=${id}`).then((response) => response.json());
